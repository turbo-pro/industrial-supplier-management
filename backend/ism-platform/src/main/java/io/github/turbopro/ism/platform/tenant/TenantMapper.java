...
public interface TenantMapper {
    ...
    @Insert("INSERT INTO iam_role_data_scope(tenant_id,role_id,resource_code,scope_type) VALUES(#{tenantId},#{roleId},'iam:organization','TENANT_ALL'),(#{tenantId},#{roleId},'iam:user','TENANT_ALL'),(#{tenantId},#{roleId},'resource:file','TENANT_ALL'),(#{tenantId},#{roleId},'print:template','TENANT_ALL'),(#{tenantId},#{roleId},'supplier:master','TENANT_ALL'),(#{tenantId},#{roleId},'supplier:admission','TENANT_ALL')")
