...
INSERT IGNORE INTO iam_role_data_scope(tenant_id,role_id,resource_code,scope_type) VALUES
 ...
 (9100,9101,'resource:person','TENANT_ALL'),(9100,9101,'resource:asset','TENANT_ALL'),(9100,9101,'safety:issue','TENANT_ALL'),(9100,9101,'safety:credential','TENANT_ALL'),(9100,9101,'safety:attendance','TENANT_ALL'),(9100,9101,'quality:ncr','TENANT_ALL');
