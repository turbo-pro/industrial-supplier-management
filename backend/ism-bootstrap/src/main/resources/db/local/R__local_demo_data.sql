-- Local profile only. Password for all demo users: Admin@123456
...
VALUES (9101,9100,'admin','租户管理员','$2y$10$P7I1Cpqar23RGcyOjR1MNOQ7vIhgIP0aJlQ3hygqasaKJjO/yWbyC','ACTIVE',0,CURRENT_TIMESTAMP(3)),
       (9103,9100,'reviewer','本地绩效审核员','$2y$10$P7I1Cpqar23RGcyOjR1MNOQ7vIhgIP0aJlQ3hygqasaKJjO/yWbyC','ACTIVE',0,CURRENT_TIMESTAMP(3));
INSERT IGNORE INTO iam_user_organization(tenant_id,user_id,organization_id,is_primary)
VALUES (9100,9101,9101,1),(9100,9101,9102,0),(9100,9103,9101,1);
INSERT IGNORE INTO iam_user_context(tenant_id,user_id,current_organization_id) VALUES (9100,9101,9101),(9100,9103,9101);
INSERT IGNORE INTO iam_role(id,tenant_id,role_code,role_name,built_in,status)
VALUES (9101,9100,'TENANT_ADMIN','租户管理员',1,'ACTIVE');
INSERT IGNORE INTO iam_user_role(tenant_id,user_id,role_id) VALUES (9100,9101,9101),(9100,9103,9101);
...
INSERT IGNORE INTO iam_role_data_scope(tenant_id,role_id,resource_code,scope_type) VALUES
 ...
 (9100,9101,'resource:person','TENANT_ALL'),(9100,9101,'resource:asset','TENANT_ALL'),(9100,9101,'safety:issue','TENANT_ALL'),(9100,9101,'safety:credential','TENANT_ALL'),(9100,9101,'safety:attendance','TENANT_ALL'),(9100,9101,'quality:ncr','TENANT_ALL'),(9100,9101,'performance:evaluation','TENANT_ALL');
