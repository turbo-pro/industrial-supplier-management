...
public class SupplierController {
    ...
    @GetMapping("/{id}/exit-readiness") @RequiresPermission("supplier:master:status")
    ApiResponse<SupplierModels.ExitReadiness> exitReadiness(@PathVariable long id){return responses.success(service.exitReadiness(id));}
