...
public final class LiftModels {
    ...
    public record Row(long id,long caseId,String reason,long evidenceFileId,String status,long createdBy,
        LocalDateTime createdAt,Long reviewedBy,LocalDateTime reviewedAt,String reviewComment,int version,long observationSeconds){}
    public record View(String id,String caseId,String reason,String evidenceFileId,String status,String createdBy,
        LocalDateTime createdAt,String reviewedBy,LocalDateTime reviewedAt,String reviewComment,int version,long observationSeconds){}
